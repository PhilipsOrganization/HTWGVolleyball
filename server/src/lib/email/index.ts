...
export async function sendEmail<T extends Record<string, any>>(component: ComponentType<SvelteComponent<T, any, any>>, config: { user: Account, subject: string, props: T }) {
