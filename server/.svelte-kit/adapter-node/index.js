...
var _use_hashes, _script_needs_csp, _style_needs_csp, _directives, _script_src, _style_src, _nonce, _options, _manifest;
...
const _DevalueError = class _DevalueError extends Error {
  /**
...
__name(_DevalueError, "DevalueError");
let DevalueError = _DevalueError;
...
__name(validate_action_return, "validate_action_return");
...
_nonce = new WeakMap();
__name(_BaseProvider, "BaseProvider");
let BaseProvider = _BaseProvider;
const _CspProvider = class _CspProvider extends BaseProvider {
  get_meta() {
...
__name(_CspProvider, "CspProvider");
let CspProvider = _CspProvider;
const _CspReportOnlyProvider = class _CspReportOnlyProvider extends BaseProvider {
  /**
   * @param {boolean} use_hashes
   * @param {import('types').CspDirectives} directives
   * @param {string} nonce
...
__name(_CspReportOnlyProvider, "CspReportOnlyProvider");
let CspReportOnlyProvider = _CspReportOnlyProvider;
const _Csp = class _Csp {
  /** @readonly */
...
const default_transform = /* @__PURE__ */ __name(({ html }) => html, "default_transform");
const default_filter = /* @__PURE__ */ __name(() => false, "default_filter");
const default_preload = /* @__PURE__ */ __name(({ type }) => type === "js" || type === "css", "default_preload");
